...
class CustomDataset(DatasetTemplate):
    def __init__(self, dataset_cfg, class_names, training=True, root_path=None, logger=None, disable_augmentation=False):
        """
        Args:
            root_path:
            dataset_cfg:
            ...
            for i in range(num_obj):
                ...
                if (used_classes is None) or names[i] in used_classes:
                    ...
                    db_info = {'name': names[i], 'path': db_path, 'gt_idx': i,
                               'box3d_lidar': gt_boxes[i], 'num_points_in_gt': gt_points.shape[0],  'difficulty': -1}
...
if __name__ == '__main__':
    ...
    if sys.argv.__len__() > 1 and sys.argv[1] == 'create_custom_infos':
        ...
        create_custom_infos(
            ...
            # data_path=ROOT_DIR/'..'/'datasets'/'2023-04-22-dynamic',
            # save_path=ROOT_DIR/'..'/'datasets'/'2023-04-22-dynamic',
