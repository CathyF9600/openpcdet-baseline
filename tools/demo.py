...
def main():
    ...
    dataset = CustomDataset( # CustomDataset instead of DemoDataset
    ...
    with torch.no_grad():
        for idx, data_dict in enumerate(dataset):
            ...
            with open(f'{export_dir}/data_dict_{idx:06d}.pkl', 'wb') as f:
            ...
            with open(f'{export_dir}/pred_dicts_{idx:06d}.pkl', 'wb') as f:
